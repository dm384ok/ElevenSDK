...
- (void)captureWithEvent:(NSString * _Nonnull)event properties:(NSDictionary<NSString *, id> * _Nullable)properties userProperties:(NSDictionary<NSString *, id> * _Nullable)userProperties userPropertiesSetOnce:(NSDictionary<NSString *, id> * _Nullable)userPropertiesSetOnce groupProperties:(NSDictionary<NSString *, id> * _Nullable)groupProperties;
